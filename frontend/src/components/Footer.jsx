              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <Link
                    key={index}
                    to={to}
                    className={`p-3 bg-white/10 rounded-full ${color} transition-all duration-300 hover:scale-110 hover:bg-white/20 backdrop-blur-sm`}
                  >
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <div>
                ...
                <p className="text-white/70">Subscribe to our newsletter for the latest updates</p>
              </div>
        ...
        <div className="border-t border-white/10 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              ...
              <button
                onClick={scrollToTop}
                className="group flex items-center space-x-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-full transition-all duration-300 hover:scale-105"
              >
                <span className="text-sm text-white/70 group-hover:text-white">Back to Top</span>
                <ArrowUp size={16} className="text-white/70 group-hover:text-white group-hover:-translate-y-1 transition-all duration-300" />
              </button>
            </div>
          </div>
        </div>
