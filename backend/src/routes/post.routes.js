...
import { createPost, getPosts, getPostbyId, deletePost, likePost, getCommentsOfPostbyId, commentOnPost, getPostsByUserId } from "../controllers/post.controller.js";
...
postRouter.get("/user/:userId", protect, getPostsByUserId);
